...
type StockRepoI interface {
	...
	UpdateQuantity(ctx context.Context, req *models.TransferQuantityRequest) error
}
...
type StaffRepoI interface {
	...
	//	GetListStaffByProduct(ctx context.Context, req *models.GetListOrderRequest) (resp *models.GetListOrderResponse, err error)
	GetListStaffWithDate(ctx context.Context, req *models.Date) (resp []models.GetListStuffProduct, err error)
}
...
type OrderRepoI interface {
	...
	GetSumOrder(ctx context.Context, req *models.GetSumRequest) (*models.GetSumResponse, error)
}

type CouponRepoI interface {
	CreateCoupon(ctx context.Context, req *models.CreateCoupon) (int, error)
	GetByID(ctx context.Context, req *models.CouponPrimaryKey) (*models.Coupon, error)
	GetList(ctx context.Context, req models.GetListCouponRequest) (resp []models.Coupon, err error)
	Delete(ctx context.Context, req *models.CouponPrimaryKey) (int64, error)
}
