...
func (r *stockRepo) UpdateQuantity(ctx context.Context, req *models.TransferQuantityRequest) error {
	...
	`
	_, err := r.db.Exec(ctx, query1,
		req.FromStoreID,
		req.ProductID,
		req.TransferQuantity,
	)
	if err != nil {
		return err
	}
