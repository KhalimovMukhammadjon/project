...
const docTemplate = `{
    ...
    "paths": {
        ...
        "/get-list/staff": {
            "get": {
                ...
                "operationId": "get_list_staff_with_date",
                "parameters": [
                    {
                        "type": "string",
                        "description": "time",
        ...
        "/order/sum": {
            "post": {
                ...
                "operationId": "get_sum_order",
                "parameters": [
                    {
                        "description": "GetSumRequest",
                        "name": "order",
                        "in": "body",
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/models.GetSumRequest"
                        }
                    }
                ],
                "responses": {
        ...
        "/transfer/quantity": {
            "post": {
                ...
                "operationId": "transfer_quantity",
                "parameters": [
                    {
                        "description": "TransferQuantityRequest",
                        "name": "stock",
                        "in": "body",
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/models.TransferQuantityRequest"
                        }
                    }
                ],
                "responses": {
    ...
    "definitions": {
        ...
        "models.TransferQuantityRequest": {
            "type": "object",
            "properties": {
                "from_store_id": {
                    "type": "integer"
